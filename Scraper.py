...
with Session() as s:
    ...
    response = s.post('https://secure.th-owl.de/studi/rds?state=user&type=1&category=auth.login&startpage=portal.vm&breadCrumbSource=portal', data={'asdf': 'kyz-ahx','fdsa': '090678Aef!','submit': 'login'})
